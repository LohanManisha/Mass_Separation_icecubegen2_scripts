## This script is to select the coincident events (which are contained in detector volume).
...
gcdfile = "/home/user/inice/src/Gen2-Scripts/python/segments/IceCubeHEX_Sunflower_240m_v4.0beta_ExtendedDepthRange.GCDScintAnt-shift.i3.gz"
...
files = glob("/home/user/inice/src/Gen2-Scripts/python/segments/CLSIM_Iron_Resample_4_times_lgE_17.2_sin2_0.0/Iron_*.i3.gz")
